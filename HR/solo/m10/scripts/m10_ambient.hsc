...
(script dormant bcs_nav_4_1_meadow_river
	(f_bcs_blip_position 170.5 80.83 -4.5 "meadow_river_nav" blip_default)
	(sleep_until (volume_test_players tv_meadow_river01))
	(f_bcs_unblip_position "meadow_river_nav")
	(wake bcs_nav_5_meadow)
)
...
(script dormant bcs_nav_5_meadow
	(f_bcs_blip_position 242.93 106.17 2.21 "meadow_nav" blip_default)
	(sleep_until (volume_test_players tv_meadow_falcon_shoot))
	(f_bcs_unblip_position "meadow_nav")
)
...
(script dormant md_3kiva_troopers_clear
	...
	(f_bcs_blip_object (ai_vehicle_get_from_squad intro_falcon_01 0) blip_default)
...
(script dormant bcs_nav_9_indoors
	(f_bcs_blip_position 323.89 52.66 4.34 "outpost_indoors_nav" blip_default)
	(sleep_until
		(or
	...
	(f_bcs_unblip_position "outpost_indoors_nav")
)
...
(script dormant obj_locate02_start
	...
	(f_bcs_blip_position 67.17 27.56 -7.10 "objective_1_5_nav" blip_default)
	(sleep_until (volume_test_players tv_1stbowl_kiva01_doorstack))
	(f_bcs_unblip_position "objective_1_5_nav")
)
