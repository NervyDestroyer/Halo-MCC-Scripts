...
(script dormant hud_flash_tower
	...
	;)
	(sleep 90)
	(f_bcs_unblip_object highlight_tower_box)
)
...
(script dormant hud_flash_evac
	...
	;)
	(sleep 90)
	(f_bcs_unblip_object highlight_evac_box)
)

(script dormant bcs_nav_jetpack_low
	(sleep 180)
	(f_bcs_blip_position 30.43 28.63 -31.38 "jetpack_nav" blip_default)
	(sleep_until (volume_test_players tv_objcon_jetpack_low_100) 1)
	(f_bcs_unblip_position "jetpack_nav")
	(f_bcs_blip_flag nav_jetpack_low_10 blip_default)
)
...
(script dormant hud_flash_evac0
	...
	;)
	(sleep 90)
	(f_bcs_unblip_object highlight_evac0_box)
	(wake bcs_nav_jetpack_low)
)
...
(script dormant md_ride_start
	...
	(chud_breadcrumbs_track_object_with_priority (ai_vehicle_get ride_falcon/pilot) 21)
	(if (>= (ai_living_count trooper3_odst1) 1)
