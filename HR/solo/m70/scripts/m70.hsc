...
(script dormant bcs_nav_mongoose
	(sleep_until (volume_test_players tv_dirt_30) 1)
	(f_bcs_blip_object (ai_vehicle_get_from_spawn_point sq_mongoose_player_0/sp_dirt_shack) blip_ordnance)
)
...
(script dormant f_goose_waypoint_control
	...
	(if (not (chud_breadcrumbs_using_revised_nav_points))
...
(script dormant bcs_nav_crane_start
	(f_bcs_blip_position 334.29 94 -8.55 "crane_nav" blip_default)
	(sleep_until (>= objcon_crane 10) 5)
	(f_bcs_unblip_position "crane_nav")

	(sleep 180)
	(f_bcs_blip_flag fl_crane_waypoint_1 blip_destination)
)
...
(script dormant f_crane_waypoint_control
	...
	(f_bcs_blip_position 391.53 111.56 -9.5 "crane_cov_nav" blip_destination)
	...
	(sleep_until (>= objcon_crane 80) 5)
	(f_bcs_unblip_position "crane_cov_nav")
...
(script dormant bcs_nav_area_platform
	(sleep_until (>= objcon_platform 10) 1)
	(f_bcs_blip_position 431.73 108.73 -2.3 "area_platform_nav" blip_default)
	(sleep_until (volume_test_players tv_area_platform) 1)
	(f_bcs_unblip_position "area_platform_nav")
)
...
(script dormant f_catwalk_waypoint_control
	...
	(sleep_until (>= objcon_catwalk 10) 5)
	(f_bcs_blip_position 402.14 92 -5.5 "catwalk_nav" blip_destination)
	...
	(sleep_until (>= objcon_catwalk 70) 5)
	(f_bcs_unblip_position "catwalk_nav")
	(wake bcs_nav_area_platform)
...
(script dormant f_cannon_cruiser
	...
	(f_bcs_unblip_object sc_cannon_cruiser_target)
	(f_cin_outro_prep)
