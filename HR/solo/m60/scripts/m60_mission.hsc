...
(script dormant bcs_nav_interior
	(sleep 90)
	(f_bcs_blip_position -115 51.58 15.81 "interior_1_nav" blip_default)
	(sleep_until (volume_test_players tv_interior_teleport) 1)
	(f_bcs_unblip_position "interior_1_nav")
	(sleep_until (>= interior_obj_control 10) 1)
	(f_bcs_blip_position -117.78 54 20.89 "interior_2_nav" blip_default)
	(sleep_until (>= interior_obj_control 60) 1)
	(f_bcs_unblip_position "interior_2_nav")
