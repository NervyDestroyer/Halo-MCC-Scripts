...
(script dormant bcs_nav_overlook_control_100
	(f_bcs_blip_position 107.74 380.91 58.57 "overlook_nav" blip_default)
	(sleep_until (>= s_objcon_ovr 100) 1)
	(f_bcs_unblip_position "overlook_nav")
)
...
(script dormant ovr_encounter
	...
	*;
	...
	(set s_objcon_ovr 50)
	(wake bcs_nav_overlook_control_100)
...
(script dormant bcs_nav_silo_start
	(f_bcs_blip_position 94 349.55 56.73 "silo_left_nav" blip_default)
	(f_bcs_blip_position 91.26 356.37 55 "silo_right_nav" blip_default)
	...
	1)
	(f_bcs_unblip_position "silo_left_nav")
	(f_bcs_unblip_position "silo_right_nav")
)
...
(script dormant bcs_nav_fields_start
	(f_bcs_blip_position 95 328.65 53.39 "fields_nav" blip_default)
	(sleep_until	
		(or
			(volume_test_players tv_fields_start)
		)
	1)
	(f_bcs_unblip_position "fields_nav")
)
...
(script dormant clf_gate_sequence
	...
	(f_bcs_blip_flag fl_clf_exit blip_destination)
