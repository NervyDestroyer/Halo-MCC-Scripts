...
(script dormant bcs_ramp_nav
	(f_bcs_blip_position 159.22 121.35 11.3 "road_ramp_nav" blip_default)
	(sleep_until (volume_test_players tv_enc_twin) 1)
	(f_bcs_unblip_position "road_ramp_nav")
)
...
(script dormant twin_waypoints
	...
	(f_bcs_blip_object sc_hud_bfg01_core blip_neutralize)
	...
	(f_bcs_unblip_object sc_hud_bfg01_core)
	(f_bcs_blip_object sc_hud_bridge blip_default)
	(wake bcs_nav_bridge_ramp)
...
(script dormant bcs_nav_bridge_ramp
	(sleep_until (> g_twin_obj_control 4) 1)
	(f_bcs_blip_position -44.55 93.23 8.6 "bridge_ramp_nav" blip_default)
	(sleep_until (> g_facility_obj_control 0) 1)
	(f_bcs_unblip_position "bridge_ramp_nav")
)
...
(script dormant bcs_nav_facility
	(f_bcs_blip_position -18.82 11.37 7.16 "facility_1_nav" blip_default)
	(sleep_until (>= g_facility_obj_control 5) 1)
	(f_bcs_unblip_position "facility_1_nav")
	(sleep_until (>= g_facility_obj_control 9) 1)
	(f_bcs_blip_position -40.27 0 11 "facility_2_nav" blip_default)
	(sleep_until (volume_test_players tv_facility_zealot_02) 1)
	(f_bcs_unblip_position "facility_2_nav")
)
...
(script dormant cannon_waypoints
	...
	(f_bcs_blip_object sc_hud_bfg02_core blip_neutralize)
...
(script dormant spire_waypoints
	...
	(f_bcs_blip_object dc_spire_01 blip_default)
