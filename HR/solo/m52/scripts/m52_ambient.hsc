...
(script dormant bcs_nav_start_falcon
	(f_bcs_blip_position 204.27 -204.79 179.37 "falcon_nav" blip_default)
	(sleep_until
		(or
	...
	(f_bcs_unblip_position "falcon_nav")
)
