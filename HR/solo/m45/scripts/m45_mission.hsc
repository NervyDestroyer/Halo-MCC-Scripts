...
(script dormant bch_encounter
	...
	(if (or (not (editor_mode)) cinematics)
		(begin 
			...
			(if (= b_cinematic_entered false) (cinematic_enter 045la_katsplan TRUE))
			(f_play_cinematic_advanced 045la_katsplan set_landing_001_005 set_landing_001_005)
...
(script dormant bcs_nav_facility
	...
	(f_bcs_blip_position -155.27 -39 11.14 "facility_nav" blip_default)
	(sleep_until (>= s_objcon_fac 130) 1)
	(f_bcs_unblip_position "facility_nav")
)
...
; -------------------------------------------------------------------------------------------------
(script dormant  bcs_nav_bridge_start
	(f_bcs_blip_position 9.58 -101.85 -5.13 "bridge_nav" blip_default)
	(sleep_until (volume_test_players tv_bridge_start) 1)
	(f_bcs_unblip_position "bridge_nav")
)
...
; ENCOUNTER LOGIC
; -------------------------------------------------------------------------------------------------
(script dormant bcs_nav_final_start
	(sleep 45)
	(f_bcs_blip_position 0 -69.26 0.55 "final_nav" blip_default)
	(sleep_until (volume_test_players tv_final_start) 1)
	(f_bcs_unblip_position "final_nav")
)
