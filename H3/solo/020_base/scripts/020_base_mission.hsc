...
;	(cs_run_command_script cortana_highway_grunt_turret02 grunt_having_fun)
	...
	(if (not (hud_breadcrumbs_using_revised_nav_points))
		(begin
...
(script dormant command_navpoint_active
	(if (not (hud_breadcrumbs_using_revised_nav_points))
		...
		(begin
			(hud_breadcrumbs_activate_team_nav_point_position player -29.94 43.46 -7 "start_stairs_nav" g_nav_offset)
			(sleep_until (<= (objects_distance_to_position (players) -29.94 43.46 -7 ) 2)1)
			(hud_breadcrumbs_deactivate_team_nav_point_position player "start_stairs_nav")
			(hud_breadcrumbs_activate_team_nav_point_flag player command_navpoint01 g_nav_offset)
		)
	)
...
(script dormant command_navpoint_deactive
	...
	(hud_breadcrumbs_deactivate_team_nav_point_flag player command_navpoint01)
)
;==============================================================
(script dormant cave_a_navpoint_active
	(if (not (hud_breadcrumbs_using_revised_nav_points))
		...
		(begin
			(sleep_until (> (device_get_position command_door_init) 0)1)
			(hud_breadcrumbs_activate_team_nav_point_object player 020_01_c2b "door_button_nav" g_nav_offset)
		)
	)
...
(script dormant cave_a_navpoint_deactive
	(if (not (hud_breadcrumbs_using_revised_nav_points))
		...
		(sleep_until (> (device_get_position cave_a_door_hallway02) 0)1)
	)
	(sleep_forever cave_a_navpoint_active)
	(sleep 1)
	(hud_deactivate_team_nav_point_flag player cave_a_navpoint)
	(hud_breadcrumbs_deactivate_team_nav_point_object player "door_button_nav")
	(wake bcs_highway_a_door_nav)
)

(script dormant bcs_highway_a_door_nav
	(hud_breadcrumbs_activate_team_nav_point_object player 020_02_c2a "door_highway_button_nav" g_nav_offset)
	(sleep_until (> (device_get_position highway_a_door) 0)1)
	(hud_breadcrumbs_deactivate_team_nav_point_object player "door_highway_button_nav")
)
...
(script dormant highway_a_navpoint_deactive
	...
	(wake bcs_to_hangar_nav)
)

(script dormant bcs_to_hangar_nav
	(hud_breadcrumbs_activate_team_nav_point_flag player hangar_a_coop_flag g_nav_offset)
	(sleep_until (<= (objects_distance_to_flag (players) hangar_a_coop_flag) 2))
	(hud_breadcrumbs_deactivate_team_nav_point_flag player hangar_a_coop_flag)
	(wake bcs_hangar_fight_nav)
)

(script dormant bcs_hangar_fight_nav
	(hud_breadcrumbs_activate_team_nav_point_position player 4.79 3.99 -9.6 "hangar_fight_nav" g_nav_offset)
	(sleep_until
		(or
			(<= (objects_distance_to_position (players) 4.79 3.99 -9.6 ) 2)
			(= g_music_020_04 TRUE)
		)
	1)
	(hud_breadcrumbs_deactivate_team_nav_point_position player "hangar_fight_nav")
)
...
(script dormant hangar_a_navpoint_deactive
	...
	(if (not (hud_breadcrumbs_using_revised_nav_points))
		...
		(begin
			(wake bcs_nav_hangar_midway)
		)
	)
)

(script dormant bcs_nav_hangar_midway
	(hud_breadcrumbs_activate_team_nav_point_flag player highway_a_navpoint g_nav_offset)
	(sleep_until (<= (objects_distance_to_flag (players) highway_a_navpoint) 2)1)
	(hud_breadcrumbs_deactivate_team_nav_point_flag player highway_a_navpoint)
	(wake hangar_a_navpoint02_active)
	(wake hangar_a_navpoint02_deactive)
)
...
(script dormant loop02_navpoint_active
	...
	(if (not (hud_breadcrumbs_using_revised_nav_points))
		...
		(hud_breadcrumbs_activate_team_nav_point_object player loop02_begin_switch "loop02_button_nav" g_nav_offset)
	)
)
...
;	(sleep_until (script_finished loop02_navpoint_active))
	...
	(if (not (hud_breadcrumbs_using_revised_nav_points))
		...
		(hud_breadcrumbs_deactivate_team_nav_point_object player "loop02_button_nav")
	)
)
;==============================================================
...
(script dormant bcs_rocks_nav
	(hud_breadcrumbs_activate_team_nav_point_position player -67.48 50.02 -4 "rocks_hole_nav" 0.2)
	(sleep_until (<= (objects_distance_to_position (players) -67.48 50.02 -4 ) 2) 1)
	(hud_breadcrumbs_deactivate_team_nav_point_position player "rocks_hole_nav")
	(wake bcs_nav_dorm_brutes)
)

(script dormant bcs_nav_dorm_brutes
	(sleep_until (volume_test_players barracks_player_vol04)5)
	(hud_breadcrumbs_activate_team_nav_point_object player 020_07_c3a "brutes_dorm_button" g_nav_offset)
	(sleep_until (> (device_get_position barracks_door_end) 0)1)
	(hud_breadcrumbs_deactivate_team_nav_point_object player "brutes_dorm_button")
	(wake bcs_nav_elevator)
)
(script dormant bcs_nav_elevator
	(hud_breadcrumbs_activate_team_nav_point_object player evac2_elev_switch01 "elevator_switch" 0.2)
	(sleep_until (> (device_get_position evac2_elev_switch01) 0)1)
	(hud_breadcrumbs_deactivate_team_nav_point_object player "elevator_switch")
)

(script dormant bcs_evac_hangar_door
	(hud_breadcrumbs_activate_team_nav_point_object player evac_hangar_control_door "evac_hangar_door" g_nav_offset)
	(sleep_until (<= (objects_distance_to_object (players) evac_hangar_control_door) 2)1)
	(hud_breadcrumbs_deactivate_team_nav_point_object player "evac_hangar_door")
)
...
(script dormant cortana_navpoint_active
	(if (not (hud_breadcrumbs_using_revised_nav_points))
		...
		(begin
			(hud_breadcrumbs_activate_team_nav_point_object player 020_08_c1a "cortana_highway_button" g_nav_offset)
		)
	)
)
(script dormant cortana_navpoint_deactive
	(if (not (hud_breadcrumbs_using_revised_nav_points))
		...
		(sleep_until (> (device_get_position cortana_encounter_door) 0)1)
	)
	(sleep_forever cortana_navpoint_active)
	(sleep 1)

	(hud_deactivate_team_nav_point_flag player cortana_highway_navpoint01)
	(hud_breadcrumbs_deactivate_team_nav_point_object player "cortana_highway_button")
	(wake bcs_nav_cortana_highway)
)

(script dormant bcs_nav_cortana_highway
	(hud_breadcrumbs_activate_team_nav_point_position player -59.05 54.32 -6.8 "cor_highway_nav" g_nav_offset)
	(sleep_until (volume_test_players cortana_highway_turret_end) 1)
	(hud_breadcrumbs_deactivate_team_nav_point_position player "cor_highway_nav")
	(wake cortana02_navpoint_active)
	(wake cortana02_navpoint_deactive)
)
;==============================================================
...
(script dormant destruct_bomb_navpoint_active
	(if (not (hud_breadcrumbs_using_revised_nav_points))
		...
		(hud_breadcrumbs_activate_team_nav_point_object player self_destruct_switch "bomb_nav" 0.2)
	)
)
(script dormant destruct_bomb_navpoint_deactive
	...
	(hud_breadcrumbs_deactivate_team_nav_point_object player "bomb_nav")
)
;==============================================================
...
(script dormant hangar_a_ret04_nav_active
	(if (not (hud_breadcrumbs_using_revised_nav_points))
		...
		(begin
			(hud_breadcrumbs_activate_team_nav_point_object player exit_elev_switch02 "elev_switch_nav" 0.2)
		)
	)
)
(script dormant hangar_a_ret04_nav_deactive
	...
	(hud_breadcrumbs_deactivate_team_nav_point_object player "elev_switch_nav")
)
