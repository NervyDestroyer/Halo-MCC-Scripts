...
(script dormant md_b1_allies_next
	...
	(sleep_until (>= s_b2_progression 20) 10)
	(hud_breadcrumbs_deactivate_team_nav_point_flag player flg_b1_next)
)

(script dormant bcs_nav_b1_next
	(sleep_until b_b1_finished)
	(hud_breadcrumbs_activate_team_nav_point_flag player flg_b1_next 0)
)
...
(script dormant md_b2_allies_next
	...
	(hud_breadcrumbs_activate_team_nav_point_flag player flg_b2_next 0)
	...
	(sleep_until (>= s_fp_progression 15) 10)
	(hud_breadcrumbs_deactivate_team_nav_point_flag player flg_b2_next)
	(hud_breadcrumbs_activate_team_nav_point_flag player flg_fp_next 0)
)
...
(script dormant md_fp_allies_next
	...
	(sleep_until (>= s_ex_progression 10))
	(hud_breadcrumbs_deactivate_team_nav_point_flag player flg_fp_next)
)
...
(script dormant bcs_nav_after_pelican
	;5.1
	(hud_breadcrumbs_activate_team_nav_point_position player -17.80 228.24 16.33 "nav_after_pelican1" 0.55)
	(sleep_until (<= (objects_distance_to_position (players) -17.80 228.24 16.33) 5)1)
	(hud_breadcrumbs_deactivate_team_nav_point_position player "nav_after_pelican1")

	;5.2
	(hud_breadcrumbs_activate_team_nav_point_position player -86.68 201.62 16.72 "nav_after_pelican2" 0.55)
	(sleep_until (<= (objects_distance_to_position (players) -86.68 201.62 16.72) 5)1)
	(hud_breadcrumbs_deactivate_team_nav_point_position player "nav_after_pelican2")

	;6
	(hud_breadcrumbs_activate_team_nav_point_flag player flg_ex_near_aw 0)
	(sleep_until (>= s_ex_progression 70) 10)
	(hud_breadcrumbs_deactivate_team_nav_point_flag player flg_ex_near_aw)

	; Activate next navpoint inmmediatly after the previous one when improved navpoints are on
	(hud_breadcrumbs_activate_team_nav_point_flag player flg_fl_frigate_landing 0)
	(sleep_until 
		(or
	...
	10)
	(hud_breadcrumbs_deactivate_team_nav_point_flag player flg_fl_frigate_landing)
)
...
(script dormant bcs_nav_wall_door
	(hud_breadcrumbs_activate_team_nav_point_flag player flg_dw_wall_door 0)
	(sleep_until 
				(or
	...
	5)
	(hud_breadcrumbs_deactivate_team_nav_point_flag player flg_dw_wall_door)
)
...
(script dormant md_abb_shipmaster_reward
	...
	(hud_breadcrumbs_activate_team_nav_point_flag player flg_shaft_door 0)
	...
	(sleep_until (>= (device_get_position shaft_door) 0.5) 5)
	(hud_breadcrumbs_deactivate_team_nav_point_flag player flg_shaft_door)
)
...
(script dormant md_f1_after_f1
	...
	(hud_breadcrumbs_activate_team_nav_point_flag player flg_f1_next 0)
	...
	(hud_breadcrumbs_deactivate_team_nav_point_flag player flg_f1_next)
...
(script dormant bcs_nav_f3_switch
	(hud_breadcrumbs_activate_team_nav_point_flag player flg_f3_switch 0)
	(sleep_until (< (device_get_position 070LC_start) 0.95) 1)
	(hud_breadcrumbs_deactivate_team_nav_point_flag player flg_f3_switch)
	(wake bcs_nav_final_exit)
)

;Wait until a player activates the cinematic
(script dormant f3_070LC_start
	(wake bcs_nav_f3_switch)
...
(script dormant bcs_nav_final_exit
	(sleep 300)
	(hud_breadcrumbs_activate_team_nav_point_position player -23.3 -56.14 -20 "nav_final_exit1" 0.55)
	(sleep_until (<= (objects_distance_to_position (players) -23.3 -56.14 -20) 2)1)
	(hud_breadcrumbs_deactivate_team_nav_point_position player "nav_final_exit1")

	(hud_breadcrumbs_activate_team_nav_point_position player -24.99 -71.74 -25 "nav_final_exit2" 0.55)
	(sleep_until (<= (objects_distance_to_position (players) -24.99 -71.74 -25) 2)1)
	(hud_breadcrumbs_deactivate_team_nav_point_position player "nav_final_exit2")

	(hud_breadcrumbs_activate_team_nav_point_position player -24.99 -87.44 -29.5 "nav_final_exit3" 0.55)
	(sleep_until (volume_test_players vol_kill_f3_4))
	(hud_breadcrumbs_deactivate_team_nav_point_position player "nav_final_exit3")
)
