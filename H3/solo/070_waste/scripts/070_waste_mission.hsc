...
(script dormant ex_longsword_search
	...
	(wake bcs_nav_phantom)
)

(script dormant bcs_nav_phantom
	(hud_breadcrumbs_activate_team_nav_point_flag player flg_sd_start_location_p2 0.55)
	(sleep_until (<= (objects_distance_to_flag (players) flg_sd_start_location_p2) 5))
	(hud_breadcrumbs_deactivate_team_nav_point_flag player flg_sd_start_location_p2)
	(wake bcs_nav_5)
)
...
(script dormant bcs_nav_5
	(hud_breadcrumbs_activate_team_nav_point_position player 24.86 183.36 21 "bcs_nav_5" 0.55)
	(sleep_until (<= (objects_distance_to_flag (players) cin_070lb_anchor) 5))
	(hud_breadcrumbs_deactivate_team_nav_point_position player "bcs_nav_5")
)
...
(script dormant bcs_frigate_landing_deactive
...
(script dormant frigate_landing
	...
	(wake bcs_frigate_landing_deactive)
...
(script dormant bcs_la_next_0_deactive
	(sleep_until (>= s_la_progression 30) 5)
	(hud_breadcrumbs_deactivate_team_nav_point_flag player flg_la_next_0)
)

(script dormant bcs_la_next_1_deactive
	(sleep_until (>= s_la_progression 50) 5)
	(hud_breadcrumbs_deactivate_team_nav_point_flag player flg_la_next_1)
)

(script dormant la_manage_checkpoints
	(game_save)

	(hud_breadcrumbs_activate_team_nav_point_flag player flg_la_next_0 0)	
	;FIRST ENCOUNTER
	(sleep_until 
		(or
			(>= s_la_progression 30)
	...
	(hud_breadcrumbs_activate_team_nav_point_flag player flg_la_next_1 0)
	;Save only if playtest is not just zooming through encounters
...
(global object o_scarab_core NONE)

(script dormant scarab_bcs_nav
	(set o_scarab_core (object_get_variant_child_object_by_marker_id bb_scarab "engine_inner_shield_top"))
	(hud_breadcrumbs_activate_team_nav_point_object player o_scarab_core "scarab_nav" 0.3)
	(sleep_until (<= (object_get_health o_scarab_core) 0))
	(hud_breadcrumbs_deactivate_team_nav_point_object player "scarab_nav")
)
...
(script dormant floor_5	
	...
	(hud_breadcrumbs_activate_team_nav_point_flag player flg_f5_pelican 0)
