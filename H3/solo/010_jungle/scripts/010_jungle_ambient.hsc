...
(script dormant nav_jw
	...
	(hud_breadcrumbs_deactivate_team_nav_point_flag player nav_jw)
)

; grunt camp nav point ==================================================================
(script dormant nav_gc

	; early breadcrumbs trigger
	(hud_breadcrumbs_activate_team_nav_point_flag player nav_gc g_nav_offset)
	...
	(if (<= g_pa_obj_control 0)
		(begin
			...
			(hud_breadcrumbs_deactivate_team_nav_point_flag player nav_gc)
			(hud_breadcrumbs_activate_team_nav_point_flag player nav_pa g_nav_offset)
		)
	)
)
...
(script dormant nav_pa
	...
	(if (<= g_pa_obj_control 4)
		(begin
			...
			(hud_breadcrumbs_deactivate_team_nav_point_flag player nav_pa)
		)
	)
)
...
(script dormant 010pb_johnson_captured
	...
	; wake breadcrumb navpoint
	(wake bcs_quid_pro_quo_nav)
)

(script dormant bcs_quid_pro_quo_nav
	(hud_breadcrumbs_activate_team_nav_point_position player 80.12 41.57 -12 "quid_pro_quo_nav" g_nav_offset)
	(sleep_until (<= (objects_distance_to_position (players) 80.12 41.57 -12) 2)1)
	(hud_breadcrumbs_deactivate_team_nav_point_position player "quid_pro_quo_nav")
	(wake bcs_dam_jail_nav)
)

(script dormant bcs_dam_jail_nav
	(hud_breadcrumbs_activate_team_nav_point_object player dam_jail "nav_jail" 1)
	(sleep_until g_dam_prisoners_free 1)
	(hud_breadcrumbs_deactivate_team_nav_point_object player "nav_jail")
)
