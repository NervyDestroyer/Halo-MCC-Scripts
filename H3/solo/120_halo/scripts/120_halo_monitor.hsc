...
(script dormant bcs_monitor_weapon_nav
	; find the spartan laser weapon object
	(sleep_until (>= (list_count (position_return_nearby_objects_by_type -118.94 -440 -3.78 20 4)) 1) 1)
	(hud_breadcrumbs_activate_team_nav_point_object player (list_get (position_return_nearby_objects_by_type -118.94 -440 -3.78 20 4) 0) "johnson_weapon_bcs_nav" 0.25)
	...
	(hud_breadcrumbs_deactivate_team_nav_point_object player "johnson_weapon_bcs_nav")
)
