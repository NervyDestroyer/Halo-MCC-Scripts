...
(script dormant exterior01_bcs_nav
	(hud_breadcrumbs_activate_team_nav_point_flag player exterior01 g_nav_offset)
	(sleep_until (<= (objects_distance_to_flag (players) exterior01) 10))
	(hud_breadcrumbs_deactivate_team_nav_point_flag player exterior01)
	(wake ziggurat_navpoint_active)
)
