...
(script dormant 050_floodvoi_mission_won
	...
	; disable last nav point
	(hud_breadcrumbs_deactivate_team_nav_point_flag player 050lb_extraction)
...
(script dormant bcs_nav_factory_b
	(hud_breadcrumbs_activate_team_nav_point_position player -4.79 -16.27 0.1 "nav_factory" 0.55)
	(sleep_until (volume_test_players tv_fb_06))
	(hud_breadcrumbs_deactivate_team_nav_point_position player "nav_factory")
...
(script dormant fs_gravemind_02
	...
	(hud_breadcrumbs_activate_team_nav_point_flag player 050lb_extraction 0.55)
