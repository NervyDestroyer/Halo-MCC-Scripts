...
(global object o_scarab_a_core NONE)
(global object o_scarab_b_core NONE)

(script dormant bcs_nav_scarab_a_deactive
	(set o_scarab_a_core (object_get_variant_child_object_by_marker_id cin_scarab_a "engine_inner_shield_top"))
	(hud_breadcrumbs_activate_team_nav_point_object player o_scarab_a_core "scarab_a_nav" 0.3)
	(sleep_until (<= (object_get_health o_scarab_a_core) 0))
	(hud_breadcrumbs_deactivate_team_nav_point_object player "scarab_a_nav")
)
(script dormant bcs_nav_scarab_b_deactive
	(set o_scarab_b_core (object_get_variant_child_object_by_marker_id cin_scarab_b "engine_inner_shield_top"))
	(hud_breadcrumbs_activate_team_nav_point_object player o_scarab_b_core "scarab_b_nav" 0.3)
	(sleep_until (<= (object_get_health o_scarab_b_core) 0))
	(hud_breadcrumbs_deactivate_team_nav_point_object player "scarab_b_nav")
)
...
(script dormant md_crater_two_scarabs
	...
	(wake bcs_nav_scarab_a_deactive)
	(wake bcs_nav_scarab_b_deactive)
