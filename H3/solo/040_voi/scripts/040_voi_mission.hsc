...
(script dormant intro
	...
	; [VSTS-1198429] MUST perform this here instead of at startup, as we need an active bsp with a structure_design containing a camera_fa_01 soft ceiling
...
(script dormant intro_nav_exit
	...
	(wake bcs_nav_hangar_door_switch1)
)

(script dormant bcs_nav_hangar_door_switch1
	(hud_breadcrumbs_activate_team_nav_point_object player factory_a_entry02_switch "nav_factory_entry" 0.2)
	(sleep_until (> (device_get_position factory_a_entry02) 0))
	(hud_breadcrumbs_deactivate_team_nav_point_object player "nav_factory_entry")
	(wake bcs_nav_hangar_door_switch2)
)
(script dormant bcs_nav_hangar_door_switch2
	(sleep 30)
	(hud_breadcrumbs_activate_team_nav_point_object player factory_a_middle_switch "nav_factory_entry2" 0.2)
	(sleep_until (> (device_get_position factory_a_middle) 0))
	(hud_breadcrumbs_deactivate_team_nav_point_object player "nav_factory_entry2")
)
...
(script dormant bcs_nav_wraith
	(hud_breadcrumbs_activate_team_nav_point_object player (ai_vehicle_get_from_starting_location lakebed_a_wraith_01/driver01) "nav_wraith" 1.5)
	(sleep_until (<= (object_get_health (ai_vehicle_get_from_starting_location lakebed_a_wraith_01/driver01)) 0))
	(hud_breadcrumbs_deactivate_team_nav_point_object player "nav_wraith")
)

(script dormant laa_nav_exit
	;wake breadcrumbs navpoints for later
	(wake bcs_nav_factory_b)
...
(script dormant bcs_nav_factory_b
	(sleep_until (volume_test_players vol_drive_lakedbed_a_end))
	(hud_breadcrumbs_activate_team_nav_point_position player -4.35 -19.2 1.1 "nav_factory_b_entry" 0.2)
	(sleep_until (> (device_get_position factory_b_entry02) 0))
	(hud_breadcrumbs_deactivate_team_nav_point_position player "nav_factory_b_entry")
	(wake bcs_nav_factory_b2)
)
(script dormant bcs_nav_factory_b2
	(sleep 30)
	(hud_breadcrumbs_activate_team_nav_point_position player 7 -18.3 -1 "nav_factory_b_entry2" 0.2)
	(sleep_until (> (device_get_position factory_b_middle) 0))
	(hud_breadcrumbs_deactivate_team_nav_point_position player "nav_factory_b_entry2")
)

(script dormant bcs_nav_wraiths_2
	(wake bcs_nav_wraith_b1)
	(wake bcs_nav_wraith_b2)
)

(script dormant bcs_nav_wraith_b1
	(hud_breadcrumbs_activate_team_nav_point_object player (ai_vehicle_get_from_starting_location lakebed_b_wraith_01/driver01) "nav_wraith_b1" 1.5)
	(sleep_until (<= (object_get_health (ai_vehicle_get_from_starting_location lakebed_b_wraith_01/driver01)) 0))
	(hud_breadcrumbs_deactivate_team_nav_point_object player "nav_wraith_b1")
)

(script dormant bcs_nav_wraith_b2
	(hud_breadcrumbs_activate_team_nav_point_object player (ai_vehicle_get_from_starting_location lakebed_b_wraith_02/driver01) "nav_wraith_b2" 1.5)
	(sleep_until (<= (object_get_health (ai_vehicle_get_from_starting_location lakebed_b_wraith_02/driver01)) 0))
	(hud_breadcrumbs_deactivate_team_nav_point_object player "nav_wraith_b2")
)
...
(script dormant ware_nav_exit
	;wake breadcrumbs navpoint for later
	(wake bcs_nav_workertown)

	(if (not (hud_breadcrumbs_using_revised_nav_points))
		(sleep_until (>= (ai_living_count ware_cov_hunters) 1) 30 (* 30 50))
	)
	(if (or
			(not (>= (ai_living_count ware_cov_hunters) 1))
...
(script dormant bcs_nav_workertown
	(sleep_until (volume_test_players vol_ware_nav_exit))
	(hud_breadcrumbs_activate_team_nav_point_position player -109.06 13.52 -0.5 "nav_workertown" 0.55)
	(sleep_until (volume_test_players vol_banshees02_start))
	(hud_breadcrumbs_deactivate_team_nav_point_position player "nav_workertown")
)

;*********************************************************************;
;Breadcrumbs Nav Point Scripts
;*********************************************************************;
(script dormant scarab_bcs_nav_exit
	(hud_breadcrumbs_activate_team_nav_point_object player (object_get_variant_child_object_by_marker_id scarab_giant "engine_inner_shield_top") "scarab_core_nav" 0.3)
	(sleep_until 
		(and
	...
	(hud_breadcrumbs_deactivate_team_nav_point_object player "scarab_core_nav")
)
...
(script startup mission_voi
	...
	(if	(and
		...
		(begin
			...
			; [VSTS-1198429] Cannot perform this at startup, no bsps are active with a structure_design containing a camera_fa_01 soft ceiling
			;(gs_camera_bounds_off)
		)
	)
	; === INSERTION POINT TEST =====================================================
