...
(script dormant breadcrumbs_nav_points_07a
	; Gravity Lift
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(sleep_until (> g_breadcrumb_nav_index 0))
			(breadcrumbs_activate_team_nav_point_position "default" player -216.5 -75.8 21.5 "nav_dervish_lift" 0)
			(sleep_until (> g_breadcrumb_nav_index 1))
			(breadcrumbs_deactivate_team_nav_point player "nav_dervish_lift")
		)
	)
	...
	(if (= g_breadcrumb_nav_index 2)
		(begin
			(sleep_until
				(or
					(< (objects_distance_to_object (players) dervish_ledge_lower_door) 2)
					(> g_breadcrumb_nav_index 2)
				)
			)
			(breadcrumbs_activate_team_nav_point_position "default" player -201.1 -120.7 8.7 "hallway_1" 0)
			...
			(breadcrumbs_deactivate_team_nav_point player "hallway_1")
			(sleep_until (> g_breadcrumb_nav_index 2))
		)
	)

	; Gravity lift to jails
	(if (= g_breadcrumb_nav_index 3)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player jail_down 0)
			(sleep_until (> g_breadcrumb_nav_index 3))
			(breadcrumbs_deactivate_team_nav_point_object player jail_down)
			(sleep_until (> g_breadcrumb_nav_index 4))
		)
	)

	; Gravity lift away from jails
	(if (= g_breadcrumb_nav_index 5)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player jail_up_effect 0)
			(sleep_until
				(or
					(volume_test_objects tv_jails (players))
					(> g_breadcrumb_nav_index 5)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player jail_up_effect)
	...
	(if (= g_breadcrumb_nav_index 6)
		(begin
			(sleep_until
				(or
					(volume_test_objects tv_room_a_tube (players))
					(> g_breadcrumb_nav_index 6)
				)
			)
			(breadcrumbs_activate_team_nav_point_position "default" player -146.1 -172.1 -8.3 "outside_1" 0)
			
			(sleep_until
				(or
					(volume_test_objects tv_grand_b (players))
					(> g_breadcrumb_nav_index 6)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "outside_1")
			(set g_breadcrumb_nav_index 7)
		)
	)

	; Door to grand staircase
	(if (= g_breadcrumb_nav_index 7)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -97 -172.0 -6.9 "grand_staircase" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -97 -172.0 -6.9) 2)
					(> g_breadcrumb_nav_index 7)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "grand_staircase")
	...
	(if (= g_breadcrumb_nav_index 8)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player midtower_ent_door 0)
			(sleep_until
				(or
					(< (objects_distance_to_object (players) midtower_ent_door) 2)
					(> g_breadcrumb_nav_index 8)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player midtower_ent_door)
	...
	(if (= g_breadcrumb_nav_index 9)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player midtower_exit 0)
			(sleep_until
				(or
					(< (objects_distance_to_object (players) midtower_exit) 2)
					(> g_breadcrumb_nav_index 9)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player midtower_exit)
			(set g_breadcrumb_nav_index 10)
		)
	)

	; Door to second grand staircase
	(if (= g_breadcrumb_nav_index 10)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 279.5 -172.0 -7.0 "grand_staircase_2" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 279.5 -172.0 -7.0) 2)
					(> g_breadcrumb_nav_index 10)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "grand_staircase_2")
	...
	(if (= g_breadcrumb_nav_index 11)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 310.5 -172.0 -7.0 "outside_2" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 310.5 -172.0 -7.0) 2)
					(> g_breadcrumb_nav_index 11)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "outside_2")
	...
	(if (= g_breadcrumb_nav_index 12)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 359.5 -172.0 -8.3 "maus_ent" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 359.5 -172.0 -8.3) 2)
					(> g_breadcrumb_nav_index 12)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "maus_ent")
			(set g_breadcrumb_nav_index 13)
		)
	)

	; Mausoleum inner entrance
	(if (= g_breadcrumb_nav_index 13)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player maus_inner_ent 0)
			(sleep_until
				(or
					(< (objects_distance_to_object (players) maus_inner_ent) 2)
					(> g_breadcrumb_nav_index 13)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player maus_inner_ent)
	...
	(if (= g_breadcrumb_nav_index 14)
		(breadcrumbs_activate_team_nav_point_position "default" player 482.7 -172.0 -8.4 "navpoint_end" 0)
	)
)

(script dormant breadcrumbs_nav_mid_jail_door
	(breadcrumbs_activate_team_nav_point_position "default" player -188.16 -135.72 -85.84 "jail_door_h" 0.5)
	(sleep_until (< (objects_distance_to_object (players) jail_door_h) 2))
	(breadcrumbs_deactivate_team_nav_point player "jail_door_h")
)

(script dormant breadcrumbs_nav_lower_jail_door
	(breadcrumbs_activate_team_nav_point_position "default" player -169.89 -138.06 -88.84 "jail_door_n" 0.5)
	(sleep_until (< (objects_distance_to_object (players) jail_door_n) 2))
	(breadcrumbs_deactivate_team_nav_point player "jail_door_n")
)
...
(script dormant sc_cell_a_ent
	...
	(wake breadcrumbs_nav_mid_jail_door)
...
(script dormant sc_cell_b_ent
	...
	(wake breadcrumbs_nav_lower_jail_door)
...
(script dormant mission_highcharity	
	...
	(wake breadcrumbs_nav_points_07a)
