...
(script dormant bcs_clear_entrance
	(sleep_until (volume_test_objects tv_e1_trigger4 (players)))
	(set g_breadcrumb_nav_index 2)
)

(script dormant breadcrumbs_nav_points_07b

	; Starting entrance 
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(wake bcs_clear_entrance)
			(sleep_until (> g_breadcrumb_nav_index 0))
			(breadcrumbs_activate_team_nav_point_position "default" player 542.85 -172.02 -20.89 "nav_entrance" 0.5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 542.85 -172.02 -20.89 ) 2)
					(> g_breadcrumb_nav_index 1)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_entrance")
			(set g_breadcrumb_nav_index 2)
		)
	)
	...
	(if (= g_breadcrumb_nav_index 2)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 513.04 -171.99 -21.68 "nav_lift_1" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 513.04 -171.99 -8.68) 10)
					(> g_breadcrumb_nav_index 2)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_lift_1")
	...
	(if (= g_breadcrumb_nav_index 3)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 389.9 -172.0 100.5 "platform_room" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 389.9 -172.0 99.7) 2)
					(> g_breadcrumb_nav_index 3)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "platform_room")
	...
	(if (= g_breadcrumb_nav_index 4)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 365.44 -172 98.62 "door_hallway" 0.6)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 365.44 -172 98.62) 2)
					(> g_breadcrumb_nav_index 4)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "door_hallway")
	...
	(if (= g_breadcrumb_nav_index 5)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player e6_cave_door1 0)
			(sleep_until
				(or
					(volume_test_objects tv_e6_final_start (players))
					(> g_breadcrumb_nav_index 5)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player e6_cave_door1)
	...
	(if (= g_breadcrumb_nav_index 6)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 367.91 -101.38 98.5 "nav_cave_1" 0)
			(sleep_until
				(or
					(volume_test_objects tv_e7_trigger2 (players))
					(> g_breadcrumb_nav_index 6)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_cave_1")
			(set g_breadcrumb_nav_index 7)
		)
	)

	; Sanctum lift entrance
	(if (= g_breadcrumb_nav_index 7)
		(begin
			...
			(breadcrumbs_activate_team_nav_point_position "default" player 401.76 -92.38 98.45 "sanctum_lift_entrance" 0)
			
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 401.76 -92.38 98.45) 2)
					(> g_breadcrumb_nav_index 7)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "sanctum_lift_entrance")
			(set g_breadcrumb_nav_index 8)
		)
	)

	; Sanctum lift control
	(if (= g_breadcrumb_nav_index 8)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player sanctum_lift_control 0.2)
			(sleep_until
				(or
					(< (device_get_position sanctum_lift) 1)
					(> g_breadcrumb_nav_index 8)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player sanctum_lift_control)
	...
	(if (= g_breadcrumb_nav_index 9)
		(begin
			(sleep_until
				(or
					(volume_test_objects tv_e10_trigger2 (players))
					(> g_breadcrumb_nav_index 9)
				)
			)
			(breadcrumbs_activate_team_nav_point_position "default" player 401.76 -57.15 112.88 "door_after_lift" 0.5)
			(sleep_until
				(or
					(> (device_get_position e10_sanctum_door) 0.5)
					(> g_breadcrumb_nav_index 9)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "door_after_lift")
	...
	(if (= g_breadcrumb_nav_index 10)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 416.15 -48.61 113.39 "nav_lift_2" 0)
			(sleep_until
				(or
					(volume_test_objects tv_e12_trigger9 (players))
					(> g_breadcrumb_nav_index 10)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_lift_2")
	...
	(if (= g_breadcrumb_nav_index 11)
		(begin
			(sleep_until
				(or
					(volume_test_objects tv_e12_conduit_check (players))
					(> g_breadcrumb_nav_index 11)
				)
			)
			(breadcrumbs_activate_team_nav_point_flag default player anchor_flag_outro1 0.5)
		)
	)
)
...
(script dormant mission_start
	...
	(wake breadcrumbs_nav_points_07b)
