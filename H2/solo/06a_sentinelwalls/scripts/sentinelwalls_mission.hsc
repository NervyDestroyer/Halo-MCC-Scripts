...
(script dormant breadcrumbs_nav_points_06a
	; Piston Switch Start
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player ins_switch_b 0)
			(sleep_until
				(or
					(or
			...
			(breadcrumbs_deactivate_team_nav_point_object player ins_switch_b)
	...
	(if (= g_breadcrumb_nav_index 1)
		(begin
			(sleep_until
				(or
					(volume_test_objects tv_hall_a_fr (players))
					(> g_breadcrumb_nav_index 1)
				)
			)
			(breadcrumbs_activate_team_nav_point_object "default" player b_switch_b 0)
			...
			(breadcrumbs_deactivate_team_nav_point_object player b_switch_b)
	...
	(if (= g_breadcrumb_nav_index 2)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player c_switch_d 0)
			(sleep_until
				(or
			...
			(breadcrumbs_deactivate_team_nav_point_object player c_switch_d)
	...
	(if (= g_breadcrumb_nav_index 3)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player d_switch_b 0)
			(sleep_until
				(or
			...
			(breadcrumbs_deactivate_team_nav_point_object player d_switch_b)
	...
	(if (= g_breadcrumb_nav_index 4)
		(begin
			...
			(breadcrumbs_activate_team_nav_point_object "default" player plug_switch_a 0)
			(breadcrumbs_activate_team_nav_point_object "default" player plug_switch_b 0)
			(breadcrumbs_activate_team_nav_point_object "default" player plug_switch_c 0)
			(breadcrumbs_activate_team_nav_point_object "default" player plug_switch_d 0)
	...
	(if (= g_breadcrumb_nav_index 5)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player plug_switch 0.1)
			(sleep_until (> g_breadcrumb_nav_index 5))
			(breadcrumbs_deactivate_team_nav_point_object player plug_switch)
	...
	(if (= g_breadcrumb_nav_index 7)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -218.5 154.1 2.5 "side_entrance" 0)

			(sleep_until
				(or
					(volume_test_objects tv_plugholder_d (players))
					(> g_breadcrumb_nav_index 7)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "side_entrance")
	...
	(if (= g_breadcrumb_nav_index 8)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player plug_landing_switch_a 0)
			
			(sleep_until
				(or
					(volume_test_objects tv_plugholder_f (players))
					(> g_breadcrumb_nav_index 8)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player plug_landing_switch_a)
	...
	(if (= g_breadcrumb_nav_index 9)
		(begin
			(sleep_until
				(or
					(volume_test_objects tv_hall_c_a (players))
					(> g_breadcrumb_nav_index 9)
				)
			)
			(breadcrumbs_activate_team_nav_point_object "default" player f_switch_a 0)
			...
			(breadcrumbs_deactivate_team_nav_point_object player f_switch_a)
	...
	(if (= g_breadcrumb_nav_index 10)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player g_switch_d 0)
			...
			(breadcrumbs_deactivate_team_nav_point_object player g_switch_d)
	...
	(if (= g_breadcrumb_nav_index 11)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player h_switch_d 0)
			
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -192.31 -9.57 -15.3) 2)
					(> g_breadcrumb_nav_index 11)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player h_switch_d)
			(set g_breadcrumb_nav_index 12)
		)
	)

	; Piston Switch ledge on higher floor
	(if (= g_breadcrumb_nav_index 12)
		(begin
			(sleep_until
				(or
					(volume_test_objects tv_piston_i (players))
					(> g_breadcrumb_nav_index 12)
				)
			)
			(breadcrumbs_activate_team_nav_point_object "default" player ledge_b_switch_d 0)
			...
			(breadcrumbs_deactivate_team_nav_point_object player ledge_b_switch_d)
			(set g_breadcrumb_nav_index 13)
		)
	)

	; Piston Switch ledge after jumping into the tunnel
	(if (= g_breadcrumb_nav_index 13)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player ledge_c_switch_d 0)
			...
			(breadcrumbs_deactivate_team_nav_point_object player ledge_c_switch_d)
	...
	(if (= g_breadcrumb_nav_index 14)
		(begin
			...
			(breadcrumbs_activate_team_nav_point_position "default" player -136.54 -2.26 -189.57 "nav_cave_end" 0.5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -136.54 -2.26 -189.57) 2)
					(> g_breadcrumb_nav_index 14)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_cave_end")
	...
	(if (= g_breadcrumb_nav_index 15)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -113.8 -5.1 -187.0 "nav_defend_end" 0)
			(sleep_until (> g_breadcrumb_nav_index 15))
			(breadcrumbs_deactivate_team_nav_point player "nav_defend_end")
		)
	)
)
...
*;
	...
	(sound_class_set_gain object_impacts .2 2)
	(sound_class_set_gain vehicle_collision .2 2)
	(sleep 60)
...
(script dormant plug_rods08
	...
	(breadcrumbs_deactivate_team_nav_point_object player plug_switch_c)
)
...
(script dormant plug_rods07
	...
	(breadcrumbs_deactivate_team_nav_point_object player plug_switch_d)
)
...
(script dormant plug_rods06
	...
	(breadcrumbs_deactivate_team_nav_point_object player plug_switch_a)
)
...
(script dormant plug_rods05
	...
	(breadcrumbs_deactivate_team_nav_point_object player plug_switch_b)
)
;*
...
;	(cs_fly_by wall_gap/p8 5)
	...
	(sound_class_set_gain object_impacts 1 2)
	(sound_class_set_gain vehicle_collision 1 2)
...
(script dormant mission_sentinelwalls	
	...
	(wake breadcrumbs_nav_points_06a)
