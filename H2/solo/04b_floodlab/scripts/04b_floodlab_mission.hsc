...
(script dormant breadcrumbs_cable_nav_a
	(breadcrumbs_activate_team_nav_point_object default player cable_target_a 0)
	(sleep_until (<= (object_get_health real_cable_a) 0))
	(breadcrumbs_deactivate_team_nav_point_object player cable_target_a)	
)
(script dormant breadcrumbs_cable_nav_b
	(breadcrumbs_activate_team_nav_point_object default player cable_target_b 0)
	(sleep_until (<= (object_get_health real_cable_b) 0))
	(breadcrumbs_deactivate_team_nav_point_object player cable_target_b)	
)
(script dormant breadcrumbs_cable_nav_c
	(breadcrumbs_activate_team_nav_point_object default player cable_target_c 0)
	(sleep_until (<= (object_get_health real_cable_c) 0))
	(breadcrumbs_deactivate_team_nav_point_object player cable_target_c)	
)

(script dormant breadcrumbs_nav_points_04b
	; Hologram room
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(sleep_until
				(or
					(volume_test_objects vol_disposal_all (players))
					(> g_breadcrumb_nav_index 0)
				)
			)
			(breadcrumbs_activate_team_nav_point_position "default" player 0 99.9 52 "navpoint_holo" 0.5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 0 99.9 52) 2)
					(> g_breadcrumb_nav_index 0)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "navpoint_holo")

			(sleep_until (> g_breadcrumb_nav_index 1))
		)
	)

	; Door after hologram room
	(if (= g_breadcrumb_nav_index 2)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 0 90.44 52 "door_after_holo" 0.5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 0 90.44 52) 2)
					(> g_breadcrumb_nav_index 2)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "door_after_holo")

			(sleep_until (> g_breadcrumb_nav_index 2))
		)
	)

	; Door when elevator reaches the bottom
	(if (= g_breadcrumb_nav_index 3)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -8.07 82.2 22 "elevator_bottom" 0.5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -8.07 82.2 22) 2)
					(> g_breadcrumb_nav_index 3)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "elevator_bottom")

			(set g_breadcrumb_nav_index 4)
		)
	)

	; Enemies room on the bottom
	(if (= g_breadcrumb_nav_index 4)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 0 55.36 20 "enemies_room" 0.5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 0 55.36 20) 2)
					(> g_breadcrumb_nav_index 4)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "enemies_room")
	...
	(if (= g_breadcrumb_nav_index 5)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player lab_exit_ext 0)
			
			(sleep_until (> g_breadcrumb_nav_index 5))
			(breadcrumbs_deactivate_team_nav_point_object player lab_exit_ext)
	...
	(if (= g_breadcrumb_nav_index 7)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player control_room_ext 0)

			(sleep_until
				(or
					(< (objects_distance_to_object (players) control_room_ext) 2)
					(> g_breadcrumb_nav_index 7)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player control_room_ext)
			(sleep_until (> g_breadcrumb_nav_index 7))
		)
	)

	; Elevator to Cable platform
	(if (= g_breadcrumb_nav_index 8)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player control_up_switch_01 .1)
			
			(sleep_until
				(or
					(> (device_get_position elev_control_up) .1)
					(> g_breadcrumb_nav_index 8)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player control_up_switch_01)
			(sleep_until (> g_breadcrumb_nav_index 8))
		)
	)

	; Attached to each of the 3 cables
	(if (= g_breadcrumb_nav_index 9)
		(begin
			(wake breadcrumbs_cable_nav_a)
			(wake breadcrumbs_cable_nav_b)
			(wake breadcrumbs_cable_nav_c)
	...
	(if (= g_breadcrumb_nav_index 10)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player control_up_switch_02 0.1)
			(sleep_until 
				(OR
					(< (device_get_position elev_control_up) .9)
					(volume_test_objects vol_going_down (players))
					(> g_breadcrumb_nav_index 10)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player control_up_switch_02)
			(set g_breadcrumb_nav_index 11)
		)
	)

	; Elevator to control room
	(if (= g_breadcrumb_nav_index 11)
		(begin
			(sleep_until
				(or
					(volume_test_objects vol_control_perimeter (players))
					(> g_breadcrumb_nav_index 11)
				)
			)
			(breadcrumbs_activate_team_nav_point_object "default" player control_down_switch_02 0.1)
			
			(sleep_until 
				(OR
					(> (device_get_position elev_control_down) 0.1)
					(< (objects_distance_to_position (players) 0 17.5 15.3) 2)
					(> g_breadcrumb_nav_index 11)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player control_down_switch_02)
	...
	(if (= g_breadcrumb_nav_index 12)
		(begin
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 0 10.65 15.9) 2)
					(> g_breadcrumb_nav_index 12)
				)
			)
			(breadcrumbs_activate_team_nav_point_position "default" player 0 -11.9 12.4 "power_core_ledge" 0)
			
			(sleep_until
				(or
					(volume_test_objects vol_power_core_ledge (players))
					(> g_breadcrumb_nav_index 12)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "power_core_ledge")
	...
	(if (= g_breadcrumb_nav_index 13)
		(begin
			(breadcrumbs_activate_team_nav_point_flag default player he_went_here 0)
			(sleep_until (> g_breadcrumb_nav_index 13))
			(breadcrumbs_deactivate_team_nav_point_flag player he_went_here)
		)
	)
	...
	(if (= g_breadcrumb_nav_index 14)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 149.9 0.2 27.1 "bottling_zone" 0)
			(sleep_until
				(or
					(= (volume_test_objects vol_hl_delete_01 (players)) TRUE)
					(> g_breadcrumb_nav_index 14)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "bottling_zone")
	...
	(if (= g_breadcrumb_nav_index 15)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 148.8 0.0 36.1 "hallway_exit" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 148.8 0.0 36.1) 2)
					(> g_breadcrumb_nav_index 15)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "hallway_exit")
	...
	(if (= g_breadcrumb_nav_index 16)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 126.9 -8.3 36.1 "end_level" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 126.9 -8.3 36.1) 2)
					(> g_breadcrumb_nav_index 16)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "end_level")
		)
	)
)
...
(script dormant arm_02_entry_start
	...
	(sound_class_set_gain unit_animation .5 1)
	...
	(sound_class_set_gain unit_animation 1 1)
...
;Mission stuff
	...
	(wake kill_volumes)
	(wake breadcrumbs_nav_points_04b)
