...
(script dormant breadcrumbs_nav_points_06b
	; Hallway
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 1.2 -18.2 -192.2 "hallway_1" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 1.2 -18.2 -192.2) 4)
	...
	(if (= g_breadcrumb_nav_index 1)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 23.51 -47.73 -195.47 "hallway_2" 0.5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 23.51 -47.73 -195.47) 4)
					(> g_breadcrumb_nav_index 1)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "hallway_2")
	...
	(if (= g_breadcrumb_nav_index 2)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 43.0 -19.0 -194.9 "double_doors" 0)
			
			(sleep_until
				(or
					(volume_test_objects tv_dam_door_a (players))
					(volume_test_objects tv_dam_door_b (players))
					(> g_breadcrumb_nav_index 2)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "double_doors")
	...
	(if (= g_breadcrumb_nav_index 3)
		(begin
			(breadcrumbs_activate_team_nav_point_flag "default" player factory_ent_b 0)
			(sleep_until
				(or
			...
			(breadcrumbs_deactivate_team_nav_point_flag player factory_ent_b)
	...
	(if (= g_breadcrumb_nav_index 4)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 173.1 -56.6 -200.9 "factory_tunnel" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 173.1 -56.6 -200.9) 2)
					(> g_breadcrumb_nav_index 4)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "factory_tunnel")
	...
	(if (= g_breadcrumb_nav_index 5)
		(begin
			(sleep_until
				(or
					(volume_test_objects tv_factory (players))
					(> g_breadcrumb_nav_index 5)
				)
			)
			(breadcrumbs_activate_team_nav_point_flag "default" player gorge_b 0)
			
			(sleep_until
				(or
					(volume_test_objects vol_factory_1_exit (players))
					(> g_breadcrumb_nav_index 5)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_flag player gorge_b)
	...
	(if (= g_breadcrumb_nav_index 6)
		(begin
			(sleep_until
				(or
					(volume_test_objects tv_gorge (players))
					(> g_breadcrumb_nav_index 6)
				)
			)
			(breadcrumbs_activate_team_nav_point_position "default" player 240.1 -33.7 -197.5 "gorge_tunnel" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 240.1 -33.7 -197.5) 2)
					(> g_breadcrumb_nav_index 6)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "gorge_tunnel")
	...
	(if (= g_breadcrumb_nav_index 7)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 270.4 -39.1 -196.3 "crate_exit" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 270.4 -39.1 -196.3) 2)
					(> g_breadcrumb_nav_index 7)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "crate_exit")
	...
	(if (= g_breadcrumb_nav_index 8)
		(begin
			...
			(breadcrumbs_activate_team_nav_point_position "default" player 424.0 -28.3 -193.2 "facility_entrance" 0.5)
			...
			(breadcrumbs_deactivate_team_nav_point player "facility_entrance")
	...
	(if (= g_breadcrumb_nav_index 9)
		(breadcrumbs_activate_team_nav_point_position "default" player 330.0 -57.7 790.0 "end_level" 0)
	)
)
