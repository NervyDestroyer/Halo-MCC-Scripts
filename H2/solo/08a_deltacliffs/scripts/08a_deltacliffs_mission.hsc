...
(script dormant breadcrumbs_nav_points_08a
	; E1 entrance
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 113.9 164.4 66.6 "entrance_1" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 113.9 164.4 66.6) 2)
					(> g_breadcrumb_nav_index 0)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "entrance_1")
	...
	(if (= g_breadcrumb_nav_index 1)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 114 152.57 66 "entrance_1_5" 0.5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 114 152.57 66) 2)
					(> g_breadcrumb_nav_index 1)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "entrance_1_5")
	...
	(if (= g_breadcrumb_nav_index 2)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 134.5 122.0 69.2 "nav_hall_2" 0)
			(sleep_until
				(or
					(volume_test_objects tv_e3_main_begin (players))
					(> g_breadcrumb_nav_index 2)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_hall_2")
			(set g_breadcrumb_nav_index 3)
		)
	)

	; E2 next door after cave
	(if (= g_breadcrumb_nav_index 3)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 134.53 106.49 66.5 "door_after_cave" 0.5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 134.53 106.49 66.5) 2)
					(> g_breadcrumb_nav_index 3)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "door_after_cave")
			(set g_breadcrumb_nav_index 4)
		)
	)

	; E2 next door to hall
	(if (= g_breadcrumb_nav_index 4)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 139.89 102.02 66.5 "door_to_hall" 0.5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 139.89 102.02 66.5) 2)
					(> g_breadcrumb_nav_index 4)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "door_to_hall")
	...
	(if (= g_breadcrumb_nav_index 5)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 157.5 82.0 56.2 "nav_hall_3" 0)
			...
			(breadcrumbs_deactivate_team_nav_point player "nav_hall_3")
	...
	(if (= g_breadcrumb_nav_index 6)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 142.36 77.98 55.5 "exit_door" 0.5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 142.36 77.98 55.5) 2)
					(> g_breadcrumb_nav_index 6)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "exit_door")
	...
	(if (= g_breadcrumb_nav_index 7)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 149.88 61.83 53.48 "exterior_cave" 0.7)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 149.88 61.83 56.58) 4)
					(> g_breadcrumb_nav_index 7)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "exterior_cave")
	...
	(if (= g_breadcrumb_nav_index 8)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 184.9 83.4 54.3 "nav_outside_1" 0)
			(sleep_until
				(or
					(volume_test_objects tv_e7_exit (players))
					(> g_breadcrumb_nav_index 8)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_outside_1")
	...
	(if (= g_breadcrumb_nav_index 9)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 241.1 95.6 52.56 "exterior_ravine" 0.7)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 241.1 95.6 52.56) 4)
					(> g_breadcrumb_nav_index 9)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "exterior_ravine")
	...
	(if (= g_breadcrumb_nav_index 10)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 316 98.47 50.55 "exterior_cave_op" 0.7)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 316 98.47 50.55) 4)
					(> g_breadcrumb_nav_index 10)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "exterior_cave_op")
	...
	(if (= g_breadcrumb_nav_index 11)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 306.9 63.9 34.7 "nav_outside_river" 0)
			(sleep_until
				(or
			...
			(breadcrumbs_deactivate_team_nav_point player "nav_outside_river")
	...
	(if (= g_breadcrumb_nav_index 12)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 214.7 46.1 14.2 "nav_basin" 0)
			(sleep_until
				(or
					(volume_test_objects tv_e10_entrance (players))
					(> g_breadcrumb_nav_index 12)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_basin")
	...
	(if (= g_breadcrumb_nav_index 13)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 210.5 38.0 13.9 "nav_armory" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 210.5 38.0 13.3) 2)
					(> g_breadcrumb_nav_index 13)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_armory")
	...
	(if (= g_breadcrumb_nav_index 14)
		(begin
			(sleep_until
				(or
					(volume_test_objects tv_e10_armory_exit (players))
					(> g_breadcrumb_nav_index 14)
				)
			)
			(breadcrumbs_activate_team_nav_point_position "default" player 190.1 9.2 13.6 "nav_cave" 0)

			(sleep_until
				(or
					(volume_test_objects tv_e10_pro_inf2_retreat3 (players))
					(> g_breadcrumb_nav_index 14)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_cave")
		)
	)
)
...
(script dormant mission_start
	...
	(wake breadcrumbs_nav_points_08a)
