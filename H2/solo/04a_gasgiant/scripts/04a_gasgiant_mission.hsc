...
(script dormant breadcrumbs_nav_points_04a

	; Door to go inside the building
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player rec_center_entry_ext 0)
			(sleep_until
				(or
					(< (objects_distance_to_object (players) rec_center_entry_ext) 2)
					(> g_breadcrumb_nav_index 0)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player rec_center_entry_ext)
	...
	(if (= g_breadcrumb_nav_index 1)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player hangar_switch02 0.1)
			(sleep_until
				(or
					(> (device_get_position elev_hangar) 0.25)
					(> g_breadcrumb_nav_index 1)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player hangar_switch02)
			(set g_breadcrumb_nav_index 2)
		)
	)

	; Hangar door switches
	(if (= g_breadcrumb_nav_index 2)
		(begin
			(sleep_until
				(or
					(volume_test_objects vol_hangar_elev_bottom (players))
					(> g_breadcrumb_nav_index 2)
				)
			)

			(breadcrumbs_activate_team_nav_point_object "default" player hangar_door_switch_l .2)
			(breadcrumbs_activate_team_nav_point_object "default" player hangar_door_switch_r .2)

			(sleep_until (> g_breadcrumb_nav_index 2))

			(breadcrumbs_deactivate_team_nav_point_object player hangar_door_switch_l)
			(breadcrumbs_deactivate_team_nav_point_object player hangar_door_switch_r)
	...
	(if (= g_breadcrumb_nav_index 4)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 125.35 0.0 40.6 "nav_hangar_exit" 0)
			(sleep_until
				(or
					(volume_test_objects vol_leaving_hangar (players))
					(> g_breadcrumb_nav_index 4)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_hangar_exit")
	...
	(if (= g_breadcrumb_nav_index 5)
		(begin
			(sleep_until
				(or
					(volume_test_objects vol_underhangar_low (players))
					(> g_breadcrumb_nav_index 5)
				)
			)
			(breadcrumbs_activate_team_nav_point_position "default" player 147.1 -0.0 36.1 "nav_underhangar_exit" 0)
			
			(sleep_until
				(or
					(< (objects_distance_to_object (players) underhangar_exit) 2)
					(> g_breadcrumb_nav_index 5)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_underhangar_exit")
			(set g_breadcrumb_nav_index 6)
		)
	)

	; Doorway after reaching bottom part of the building
	(if (= g_breadcrumb_nav_index 6)
		(begin
			(sleep_until
				(or
					(volume_test_objects vol_hl_delete_01 (players))
					(> g_breadcrumb_nav_index 6)
				)
			)
			(breadcrumbs_activate_team_nav_point_position "default" player 131.48 -8.46 26.5 "nav_bottom_doorway" 0.5)
			
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 131.48 -8.46 26.5) 2)
					(> g_breadcrumb_nav_index 6)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_bottom_doorway")
	...
	(if (= g_breadcrumb_nav_index 7)
		(begin
			(sleep_until
				(or
					(< (objects_distance_to_object (players) viewroom_entry) 2)
					(> g_breadcrumb_nav_index 7)
				)
			)
			(breadcrumbs_activate_team_nav_point_position "default" player 115.48 0 26.5 "nav_banshees" 0.5)
			(sleep_until (> g_breadcrumb_nav_index 7))
			(breadcrumbs_deactivate_team_nav_point player "nav_banshees")
	...
	(if (= g_breadcrumb_nav_index 9)
		(begin
			(breadcrumbs_activate_team_nav_point_object default player (list_get (ai_actors allied_phantom_01) 0) 3)
			(sleep_until (> g_breadcrumb_nav_index 9))
			(breadcrumbs_deactivate_team_nav_point_object player (list_get (ai_actors allied_phantom_01) 0))
		)
	)

	; End of level
	(if (= g_breadcrumb_nav_index 10)
		(breadcrumbs_activate_team_nav_point_object default player arm_02_entry_ext 0)
	)
)
...
(script dormant dogfight_firsttime_start
	...
	(sound_class_set_gain ambient_nature .15 3)
	(sound_class_set_gain vehicle_engine .8 3)
	(sound_class_set_gain weapon_fire .8 3)
	(sound_class_set_gain weapon_fire_lod .8 3)
	(sound_class_set_gain projectile_detonation .8 3)
	(game_save)
...
;Mission stuff
	...
	(wake breadcrumbs_nav_points_04a)
