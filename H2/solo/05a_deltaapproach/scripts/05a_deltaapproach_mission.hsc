...
(global object lz_turret_01 none)
(global object lz_turret_02 none)
(global object lz_turret_03 none)
(global object lz_turret_04 none)

(script dormant bcs_starting_turret_01
	(set lz_turret_01 (list_get (ai_actors LZ_turrets_01) 0))
	(breadcrumbs_activate_team_nav_point_object "default" player lz_turret_01 0.1)
	(sleep_until
		(or
			(> g_breadcrumb_nav_index 1)
			(<= (object_get_health lz_turret_01) 0)
		)
	)
	(breadcrumbs_deactivate_team_nav_point_object player lz_turret_01)
)

(script dormant bcs_starting_turret_02
	(set lz_turret_02 (list_get (ai_actors LZ_turrets_02) 0))
	(breadcrumbs_activate_team_nav_point_object "default" player lz_turret_02 0.1)
	(sleep_until
		(or
			(> g_breadcrumb_nav_index 1)
			(<= (object_get_health lz_turret_02) 0)
		)
	)
	(breadcrumbs_deactivate_team_nav_point_object player lz_turret_02)
)

(script dormant bcs_starting_turret_03
	(set lz_turret_03 (list_get (ai_actors LZ_turrets_03) 0))
	(breadcrumbs_activate_team_nav_point_object "default" player lz_turret_03 0.1)
	(sleep_until
		(or
			(> g_breadcrumb_nav_index 1)
			(<= (object_get_health lz_turret_03) 0)
		)
	)
	(breadcrumbs_deactivate_team_nav_point_object player lz_turret_03)
)

(script dormant bcs_starting_turret_04
	(set lz_turret_04 (list_get (ai_actors LZ_turrets_04) 0))
	(breadcrumbs_activate_team_nav_point_object "default" player lz_turret_04 0.1)
	(sleep_until
		(or
			(> g_breadcrumb_nav_index 1)
			(<= (object_get_health lz_turret_04) 0)
		)
	)
	(breadcrumbs_deactivate_team_nav_point_object player lz_turret_04)
)

(script dormant breadcrumbs_nav_points_05a
	; Intro turrets
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(sleep_until (> g_breadcrumb_nav_index 0))
			(wake bcs_starting_turret_01)
			(wake bcs_starting_turret_02)
			(wake bcs_starting_turret_03)
			(wake bcs_starting_turret_04)
			(sleep_until (> g_breadcrumb_nav_index 1))
		)
	)

	; Path after warthog is dropped
	(if (= g_breadcrumb_nav_index 2)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -262.16 -219.78 42.35 "warthog_path" 1)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -262.16 -219.78 42.35) 6)
					(> g_breadcrumb_nav_index 2)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "warthog_path")
	...
	(if (= g_breadcrumb_nav_index 3)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player da_bridge_switch 0.1)
			
			(sleep_until (> g_breadcrumb_nav_index 4))
			(breadcrumbs_deactivate_team_nav_point_object player da_bridge_switch)

			(sleep_until (> g_breadcrumb_nav_index 5))
		)
	)

	; Winding path entrance
	(if (= g_breadcrumb_nav_index 6)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -135.6 -293.4 26.2 "nav_winding_path" 0)
			(sleep_until
				(or
					(volume_test_objects vol_winding_path (players))
					(> g_breadcrumb_nav_index 6)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_winding_path")
	...
	(if (= g_breadcrumb_nav_index 7)
		(begin
			(sleep_until
				(or
					(volume_test_objects vol_old_temple_ent_ent (players))
					(> g_breadcrumb_nav_index 7)
				)
			)
			(breadcrumbs_activate_team_nav_point_position "default" player -76.28 -319.5 21.5 "nav_old_temple_entrance" 0)

			(sleep_until
				(or
					(volume_test_objects vol_tunnel_03 (players))
					(> g_breadcrumb_nav_index 7)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_old_temple_entrance")
	...
	(if (= g_breadcrumb_nav_index 8)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -52.7 -317.6 22.6 "nav_old_temple" 0)
			(sleep_until
				(or
					(volume_test_objects vol_old_temple_court_01 (players))
					(> g_breadcrumb_nav_index 8)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_old_temple")
	...
	(if (= g_breadcrumb_nav_index 9)
		(begin
			(breadcrumbs_activate_team_nav_point_flag default player courtyard_exit 0)
			(sleep_until
				(or
					(< (objects_distance_to_flag (players) courtyard_exit) 4)
					(> g_breadcrumb_nav_index 9)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_flag player courtyard_exit)
	...
	(if (= g_breadcrumb_nav_index 10)
		(begin
			(breadcrumbs_activate_team_nav_point_flag default player grotto_exit 0)
			(sleep_until
				(or
					(< (objects_distance_to_flag (players) grotto_exit) 4)
					(> g_breadcrumb_nav_index 10)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_flag player grotto_exit)
			(set g_breadcrumb_nav_index 11)
		)
	)

	; End of level tower entrance
	(if (= g_breadcrumb_nav_index 11)
		(begin
			(sleep_until
				(or
					(volume_test_objects vol_approach (players))
					(> g_breadcrumb_nav_index 11)
				)
			)
			(breadcrumbs_activate_team_nav_point_position "default" player -8.87 -224.78 17.16 "nav_tower_defend" 0.5)
			
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -8.87 -224.78 17.16) 3)
					(> g_breadcrumb_nav_index 11)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_tower_defend")
		)
	)
)
...
;Mission stuff
	...
	(wake breadcrumbs_nav_points_05a)
