...
;==============================================================
(script dormant breadcrumbs_nav_points_03a
	; Turret in the first level zone
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player e1_gun .2)
			(sleep_until
				(or
					(and
						(< (objects_distance_to_object (players) e1_gun) 2)
						(player_in_vehicle)
					)
					(> g_breadcrumb_nav_index 0)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player e1_gun)
	...
	(if (= g_breadcrumb_nav_index 1)
		(begin
			(breadcrumbs_activate_team_nav_point_object "default" player e2_hunter_door 0.1)
			(sleep_until
				(or
					(< (objects_distance_to_object (players) e2_hunter_door) 2)
					(> g_breadcrumb_nav_index 1)
				)
			)
			(breadcrumbs_deactivate_team_nav_point_object player e2_hunter_door)
		)
	)

	; Entrance of Zanzibar hotel
	(if (= g_breadcrumb_nav_index 1)
		(begin
			(sleep_until
				(or
			...
			(breadcrumbs_activate_team_nav_point_position "default" player -511.6 -589.6 0.6 "navpoint_hotel" 0)
			(sleep_until
				(or
			...
			(breadcrumbs_deactivate_team_nav_point player "navpoint_hotel")
	...
	(if (= g_breadcrumb_nav_index 2)
		(begin
			...
			(if (not (player_in_vehicle))
				(breadcrumbs_activate_team_nav_point_object "default" player g_e8_warthog 0.3)
			)
			(sleep_until
				(or
					(player_in_vehicle)
			...
			(breadcrumbs_deactivate_team_nav_point_object player g_e8_warthog)
	...
	(if (= g_breadcrumb_nav_index 3)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -584.0 -364.5 -2.3 "navpoint_tunnel" 0)
			(sleep_until
				(or
			...
			(breadcrumbs_deactivate_team_nav_point player "navpoint_tunnel")
	...
	(if (= g_breadcrumb_nav_index 4)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -603.41 -327.6 -4.0 "tunnel_door" 0.5)
			(sleep_until
				(or
					(volume_test_objects tv_e12_main_begin (players))
					(> g_breadcrumb_nav_index 4)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "tunnel_door")
	...
	(if (= g_breadcrumb_nav_index 5)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -577.45 -95.86 -6.8 "tunnel_hole" 0.5)
			(sleep_until
				(or
					(volume_test_objects tv_e12_scarab_begin (players))
					(> g_breadcrumb_nav_index 5)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "tunnel_hole")
			(set g_breadcrumb_nav_index 6)
		)
	)

	; In the tunnel, before road goes down
	(if (= g_breadcrumb_nav_index 6)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -624.09 174.14 -7.9 "tunnel_down" 0.5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -624.09 174.14 -7.9) 7)
					(> g_breadcrumb_nav_index 6)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "tunnel_down")
			(set g_breadcrumb_nav_index 7)
		)
	)

	; In the tunnel, before a ramp
	(if (= g_breadcrumb_nav_index 7)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -797.53 254.8 -11.22 "tunnel_ramp" 0.5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -797.53 254.8 -11.22) 7)
					(> g_breadcrumb_nav_index 7)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "tunnel_ramp")
	...
	(if (= g_breadcrumb_nav_index 8)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -487.5 324.6 -6.5 "navpoint_end" 0)
			(sleep_until (> g_breadcrumb_nav_index 8))
			(breadcrumbs_deactivate_team_nav_point player "navpoint_end")
		)
	)
)
...
(script dormant mission_start
	...
	; Wake the breadcrumb navpoints
	(wake breadcrumbs_nav_points_03a)
