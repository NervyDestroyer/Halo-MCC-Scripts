...
(script dormant breadcrumbs_nav_points_08b
	; Start of the path
	(if (= g_breadcrumb_nav_index 0)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 154.5 -36.58 12.68 "initial_path" 0.7)
			(sleep_until
				(or
					(volume_test_objects tv_e1_advance1 (players))
					(> g_breadcrumb_nav_index 0)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "initial_path")
	...
	(if (= g_breadcrumb_nav_index 1)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 8.52 -28 16 "nav_entrance_1" 0.5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 8.52 -28 16) 2)
					(> g_breadcrumb_nav_index 1)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_entrance_1")
	...
	(if (= g_breadcrumb_nav_index 2)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -16.0 20.0 20.6 "nav_cave_exit" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -16.0 20.0 20.6) 2)
					(> g_breadcrumb_nav_index 2)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_cave_exit")
	...
	(if (= g_breadcrumb_nav_index 3)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 24.0 12.0 22.0 "nav_hall_1" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 24.0 12.0 22.0) 2)
					(> g_breadcrumb_nav_index 3)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_hall_1")
			(set g_breadcrumb_nav_index 4)
		)
	)

	; Door before the hallway
	(if (= g_breadcrumb_nav_index 4)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 43.4 12 21.35 "nav_hall_door" 0.5)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) 43.4 12 21.35) 2)
					(> g_breadcrumb_nav_index 4)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_hall_door")
	...
	(if (= g_breadcrumb_nav_index 5)
		(begin
			(breadcrumbs_activate_team_nav_point_flag default player player0_e8_start 0)
			(sleep_until
				(or
			...
			(breadcrumbs_deactivate_team_nav_point_flag player player0_e8_start)
			(sleep_until (> g_breadcrumb_nav_index 5))
		)
	)

	; Entrance after door blasted open
	(if (= g_breadcrumb_nav_index 6)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player 15.0 153.9 23.7 "nav_cave_entrance" 0)
			(sleep_until
				(or
			...
			(breadcrumbs_deactivate_team_nav_point player "nav_cave_entrance")
	...
	(if (= g_breadcrumb_nav_index 7)
		(begin
			(breadcrumbs_activate_team_nav_point_position "default" player -1.8 178.7 24.8 "nav_hallway_ent" 0)
			(sleep_until
				(or
					(< (objects_distance_to_position (players) -1.8 178.7 24.8) 2)
					(> g_breadcrumb_nav_index 7)
				)
			)
			(breadcrumbs_deactivate_team_nav_point player "nav_hallway_ent")
	...
	(if (= g_breadcrumb_nav_index 8)
		(breadcrumbs_activate_team_nav_point_object "default" player (ai_get_object e13_pro_tartarus/tartarus0) 0.3)
	)
)
...
(script dormant e12_cov_banshees0_main
	...
	(breadcrumbs_activate_team_nav_point_object "default" player (ai_vehicle_get_from_starting_location e12_cov_banshees0/banshee0) 1)
	...
	(breadcrumbs_deactivate_team_nav_point_object player (ai_vehicle_get_from_starting_location e12_cov_banshees0/banshee0))
)
...
(script dormant e11_door_opening
	...
	; Open the door
	(sound_impulse_start sound_remastered\visual_effects\deltacontrol_bigdoorexplosion NONE 1)
		...
		(begin
			...
			(if (< (objects_distance_to_object (players) scarab) 40)
				(begin
					...
					(breadcrumbs_deactivate_team_nav_point_object player scarab)
				)
			)
			...
			(if (> (objects_distance_to_object (players) scarab) 60)
				(begin
					...
					(breadcrumbs_activate_team_nav_point_object "default" player scarab 10)
				)
			)
...
(script dormant mission_start
	...
	(wake breadcrumbs_nav_points_08b)
